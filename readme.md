...
- `ipv4cidr.txt`：**2026-01-13** 从 `bgp.he.net/AS13335` 抓取整理，筛选条件为 **visibility > 90%** 的 Cloudflare IPv4 前缀（每行一个 CIDR）。
- `ipv6cidr.txt`：**2026-01-13** 从 `bgp.he.net/AS13335` 抓取整理，筛选条件为 **visibility > 90%** 的 Cloudflare IPv6 前缀（每行一个 CIDR）。
