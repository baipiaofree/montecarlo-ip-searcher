...
**传统 IP 优选工具的问题：**
- IPv4：全段扫描，需要探测数万个 IP，耗时长
- IPv6：地址空间太大只能随机打靶，结果不稳定
- 大量采样请求容易触发运营商风控
...
| 特性 | 说明 |
|------|------|
| **递进式下钻** | 不做全段扫描，而是对表现好的子网逐步"下钻拆分"，把探测预算集中到更有潜力的区域，快速收敛到最优解 |
...
| **强制直连** | 自动忽略系统代理设置，确保测速结果不被代理污染 |
| **IPv4/IPv6 双栈** | 同时支持 v4 和 v6，可混合输入 |

**效果对比：** 同样找到优质 IP，mcis 通常只需要传统工具 1/10 到 1/5 的探测次数。
